...
local APIService() = kube._Object("apiregistration.k8s.io/v1beta1", "APIService", "") {
  ...
  spec: {
    ...
    service: {
      ...
      namespace: spec.service_.metadata.namespace,
    },
  },
};
...

{
            ...
            containers_+: {
              apiserver: kube.Container("apiserver") {
                ...
                args_+: {
                  ...
                  feature_gates_:: ["OriginatingIdentity", "NamespacedServiceBroker"],
  ...
  cm: {
    sa: kube.ServiceAccount($.p+"controller-manager") + $.namespace ,
